...
var TCheckbox = (_class = (_temp = _class2 = function (_React$Component) {
  ...
  function TCheckbox(props) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(TCheckbox).call(this, props));
  ...
  (0, _createClass3.default)(TCheckbox, [{
    ...
    value: function render() {
      ...
      return checkable ? _react2.default.createElement(
        ...
        _react2.default.createElement(_antd.Checkbox, { onChange: this.handleChange, checked: this.props.checked })
      ) : false;
    }
  }]);
  return TCheckbox;
