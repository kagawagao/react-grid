        ...
        columns.map(function (item, index) {
          ...
          return _react2.default.createElement(
            ...
            item.sortable ? _react2.default.createElement(
              ...
              _react2.default.createElement(_icon2.default, { title: locale.asc || '升序', className: _this2.state.active === 'asc' && _this2.state.name === item.name ? 'nd-active' : false, onClick: _this2.handleSort.bind(_this2, 'asc', item.name), type: 'caret-up' }),
              _react2.default.createElement(_icon2.default, { title: locale.desc || '降序', className: _this2.state.active === 'desc' && _this2.state.name === item.name ? 'nd-active' : false, onClick: _this2.handleSort.bind(_this2, 'desc', item.name), type: 'caret-down' })
            ) : false
          );
        }),
