...
var _style = require('antd/lib/pagination/style');
...
var GPagination = (_class = (_temp = _class2 = function (_React$Component) {
  ...
  function GPagination() {
    ...
    return (0, _possibleConstructorReturn3.default)(this, (GPagination.__proto__ || (0, _getPrototypeOf2.default)(GPagination)).apply(this, arguments));
  }
  ...
  (0, _createClass3.default)(GPagination, [{
    ...
    value: function render() {
      ...
      return pagination && pagination.total && pagination.size < pagination.total ? _react2.default.createElement(
        'div',
        { className: 'nd-pagination' },
        _react2.default.createElement(_pagination2.default, { current: pagination.currentPage, defaultCurrent: pagination.currentPage, onChange: this._handlePageChange, total: pagination.total, locale: locale, pageSize: pagination.size })
      ) : null;
    }
  }]);
  return GPagination;
