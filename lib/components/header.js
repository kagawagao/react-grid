    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        batchActions.map(function (action, index) {
          return _react2.default.createElement(_button2.default, { actionType: 'batch', key: index, name: action.name, action: action.action, checkedSet: _this2.props.checkedSet, dataSource: _this2.props.dataSource, uniqueId: _this2.props.uniqueId, renderFunc: action.render });
        })
      );
    }
  }]);
